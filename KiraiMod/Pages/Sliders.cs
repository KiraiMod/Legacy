namespace KiraiMod.Pages
{
    public class Sliders
    {
        public Sliders()
        {
            ...
            Shared.menu.CreateSlider("p5/rgb-speed", "RGB Speed", 1.25f, -0.25f, 0f, 4f, Utils.fRGBSpeed, Shared.menu.pages[(int)Menu.PageIndex.sliders1].transform, new System.Action<float>(value =>
            {
